...
//               className="w-full rounded-xl cursor-pointer bg-[#6B8E23] py-3.5 text-sm font-semibold text-[#EDF3E7] shadow-md transition-all hover:bg-[#2F3A2F]/90 active:scale-[0.995] disabled:cursor-not-allowed disabled:opacity-40 disabled:scale-100 mt-2"
//             >
