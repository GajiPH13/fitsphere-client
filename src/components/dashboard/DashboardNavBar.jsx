...
export default function DashboardNavBar() {
  ...
  return (
    <>
      <header
        className={
          "fixed top-0 left-1/2 z-50 w-full -translate-x-1/2 border-b border-[#d7dfc6]/60 px-4 transition-all duration-300 md:px-20 dark:border-white/10 " +
          (scrolled
            ? "bg-[#f4f6ee]/90 py-1 shadow-md dark:bg-[#101510]/90"
            : "bg-[#f4f6ee]/70 py-2 dark:bg-[#101510]/70")
        }
        style={{
          backdropFilter: "blur(18px)",
          WebkitBackdropFilter: "blur(18px)",
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-2 py-2 md:px-6">
          ...
          >
            <div className="relative w-full max-w-xl">
              <Magnifier
                size={18}
                className="absolute left-4 top-1/2 -translate-y-1/2 text-[#5D6B57] dark:text-white/60"
              />
              ...
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
                placeholder="Search dashboard..."
                className="h-11 w-full rounded-full border border-[#d7dfc6]/70 bg-white/60 pl-12 pr-5 text-sm font-medium text-[#2f3a2f] outline-none backdrop-blur-xl transition focus:border-[#6B8E23] focus:bg-white/80 focus:ring-2 focus:ring-[#6B8E23]/20 dark:border-white/10 dark:bg-white/10 dark:text-white dark:placeholder:text-white/40 dark:focus:bg-white/15"
              />
            </div>
          </form>
            ...
            {!loading && session ? (
              <>
                ...
                <div className="flex items-center gap-2 border-r border-[#d7dfc6]/60 pr-2 dark:border-white/10">
                  ...
                  <div className="flex max-w-[130px] flex-col">
                    <span className="truncate text-xs font-semibold text-[#2f3a2f] dark:text-white">
                      {user?.name}
                    </span>
                    <span className="truncate text-[10px] font-medium uppercase text-[#6B8E23] dark:text-[#A3B18A]">
                      {user?.role}
                    </span>
                  </div>
                </div>
                ...
                <button
                  type="button"
                  onClick={handleSignOut}
                  className="flex items-center gap-2 rounded-full border border-red-200 bg-white/50 px-4 py-2 text-sm font-medium text-red-700 shadow-sm transition hover:bg-red-50 dark:border-red-400/20 dark:bg-red-500/10 dark:text-red-300 dark:hover:bg-red-500/20"
                >
                  Log Out
                </button>
              </>
          ...
          <div>
            ...
            <form onSubmit={handleSearch} className="mb-5">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search dashboard..."
                  className="h-11 w-full rounded-xl border border-[#d7dfc6]/70 bg-white/70 pl-11 pr-4 text-sm text-[#2f3a2f] outline-none focus:border-[#6B8E23] dark:border-white/10 dark:bg-white/10 dark:text-white dark:placeholder:text-white/40"
                />
              </div>
            </form>
            ...
            <nav className="flex flex-col gap-1">
              ...
              <Link
                href="/"
                onClick={() => setIsOpen(false)}
                className="w-full rounded-xl px-4 py-3 text-left text-sm font-medium text-[#4b5a4b] transition-all hover:bg-black/5 hover:text-[#2f3a2f] dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white"
              >
                Back to Website
              </Link>
            </nav>
          ...
          {!session && !loading && (
            <div className="flex flex-col gap-2 border-t border-[#d7dfc6]/60 pt-4 dark:border-white/10">
              ...
              <Link
                href="/auth/signin"
                onClick={() => setIsOpen(false)}
                className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-[#a3b18a]/60 bg-white/60 text-sm font-semibold text-[#2f3a2f] dark:border-white/10 dark:bg-white/10 dark:text-white"
              >
                <PersonFill size={16} />
                Login
              </Link>
...
function NotificationBell({
  ...
  return (
    <div className="group relative">
      <button
        type="button"
        className="relative flex h-10 w-10 items-center justify-center rounded-full border border-[#d7dfc6]/70 bg-white/60 text-[#2F3A2F] shadow-sm transition hover:bg-white dark:border-white/10 dark:bg-white/10 dark:text-white dark:hover:bg-white/15"
        aria-label="Notifications"
      >
        <BellDot size={18} />
      ...
      <div className="invisible absolute right-0 top-12 z-50 w-80 rounded-2xl border border-[#d7dfc6]/70 bg-white p-4 opacity-0 shadow-xl transition-all group-hover:visible group-hover:opacity-100 dark:border-white/10 dark:bg-[#151b14]">
        <div className="flex items-center justify-between">
          <h4 className="text-sm font-bold text-[#2F3A2F] dark:text-white">
            Notifications
          </h4>
          <span className="rounded-full bg-[#EDF3E7] px-2 py-1 text-[10px] font-bold text-[#6B8E23] dark:bg-white/10 dark:text-[#A3B18A]">
            {notificationCount} new
          </span>
        </div>
        ...
        <div className="mt-3 space-y-2">
          {notifications.length > 0 ? (
            notifications.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  onClick={() => onRead(item.id)}
                  className={`block rounded-xl px-3 py-2 text-xs font-medium transition hover:bg-[#DDE5D0] dark:hover:bg-white/10 ${
                    isRead
                      ? "bg-gray-100 text-gray-500 dark:bg-white/5 dark:text-white/40"
                      : "bg-[#EDF3E7] text-[#4B5A42] dark:bg-white/10 dark:text-white/80"
                  }`}
                >
                  <div className="flex items-start justify-between gap-3">
                    <span>{item.text}</span>
                  ...
                  <span className="mt-1 block text-[10px] font-semibold text-[#6B8E23] dark:text-[#A3B18A]">
                    Open →
                  </span>
                </Link>
              );
            ...
            <p className="rounded-xl bg-[#EDF3E7] px-3 py-2 text-xs font-medium text-[#4B5A42] dark:bg-white/10 dark:text-white/70">
              No notifications available.
            </p>
          )}
        </div>
